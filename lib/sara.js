...
3. Si el lead quiere cambiar la cita, usa action: "show_slots"`,
...
RESPONDE ÚNICAMENTE CON ESTE JSON (sin texto fuera del JSON):
{
  ...
  "action": "send_message" | "show_slots" | "book_appointment" | "handoff" | "unsubscribe" | "wait",
...
async function getSaraDecision(clinic, lead, qualification, conversationHistory) {
