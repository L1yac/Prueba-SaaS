...
function buildSystemPrompt(clinic, lead, qualification, hasHistory) {
  const stateGuide = {
    CONTACTADO: `El lead acaba de entrar. Tu objetivo es agendar una cita lo antes posible con el mínimo de mensajes.
${hasHistory ? "El lead ya recibió tu saludo. NO te presentes de nuevo." : "Preséntate en una frase."}
1. Pregunta solo qué tratamiento busca (una sola pregunta).
2. En cuanto responda, pon status_update: "CALIFICADO" y pasa a mostrar huecos.
NO preguntes por seguro, urgencia ni disponibilidad. Eso lo gestiona la clínica en la visita.`,
