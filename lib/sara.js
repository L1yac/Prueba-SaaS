...
1. Ofrecer horarios disponibles (usa action: "show_slots")
2. Cuando el lead confirme un horario con el número (1 o 2), usa action: "book_appointment" con el slot en appointment_slot
3. Si el lead dice que no puede o pide otro día/hora, usa action: "ask_availability" y pregunta qué día le viene mejor
4. Si hay objeción de precio, explica el valor brevemente`,
