...
Una sola pregunta por mensaje. Cuando tengas los 4 datos, pon status_update: "CALIFICADO".`,
    ...
    CALIFICADO: `El lead está calificado. REGLAS ESTRICTAS para esta fase:
- NUNCA sugieras horas tú mismo. NUNCA digas "¿A las 09:00?" ni similares.
- SIEMPRE usa action: "show_slots" para mostrar los huecos reales del calendario. Hazlo en cuanto el lead muestre interés en una cita.
- Si el lead dice un día preferido (ej: "mañana", "el lunes"), usa show_slots con preferred_date con esa fecha en formato YYYY-MM-DD.
- Después de mostrar los slots, el lead responderá con "1" o "2". Entonces usa action: "book_appointment" con el appointment_slot exacto del hueco elegido.
- Si el lead no puede en los horarios mostrados, usa action: "ask_availability" y pregunta qué día le viene mejor.
- NUNCA confirmes una cita sin haber usado book_appointment.`,
